...
n_set = set(randint(1, 20) for i in range(int(input('Number of elements of the first set: '))))
print(n_set)
m_set = set(randint(1, 20) for i in range(int(input('Number of elements of the second set: '))))
print(m_set)
